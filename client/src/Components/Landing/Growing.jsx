        ...
        <div className={styles.counts}>
          ...
          >
            ...
            <div className={styles.para}>
              ZOPGOBus is trusted by over 23 million happy customers globally
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div className={styles.para}>
              network of over 2600 ZOPGObus operators worldwide
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div className={styles.para}>
              Over 180 million trips booked using ZOPGOBus
            </div>
          </div>
        </div>
      </div>
